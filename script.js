...
// Números de entrada pela tecla pressionada
function input(num){
...
// Todas as cores para diferentes temas
const theme = {
    defaul(){
...
// Verificando a preferência de temas do usuário
const darkThemeMq  = window.matchMedia("(prefers-color-scheme: dark)");
const lightThemeMq = window.matchMedia("(prefers-color-scheme: light)");

// Mudando o tema com os resultados acima
...
// Cria uma função para receber o valor da faixa de entrada
function myFunction_set(val) {
    // Recebendo o valor do intervalo do tipo de entrada
